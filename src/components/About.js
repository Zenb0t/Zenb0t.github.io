    ...
    return (
        <main className="about">
            ...
            <hr></hr>
                ...
                based APIs in the backend. The tools for the craft can be
                seen in the stack page since I am always playing with something
                ...
                my analytical and creative skills to pragmatically build functional
                and beautiful software.</p>
        </main>
    );
}
